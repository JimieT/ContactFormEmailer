...
namespace ContactFormEmailer.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : ContactFormEmailer.Web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void ContactUsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ContactFormEmailer.Web.Models.ContactUsViewModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult ContactUs(ContactFormEmailer.Web.Models.ContactUsViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ContactUs);
